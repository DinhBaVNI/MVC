...
<body>
    <div class="Sum">
		...
		<div class="nav fixed-top">
			...
			<ul class="list-right">
				<li class="dang-nhap"><a href="?page=login">Đăng nhập</a></li>
                <span>|</span>
        ...
        <!-- Phần header -->
		<div class="header">
			<a href="index.php"><img src="img/logo/Logo-name.jpg" alt="" width="120" height="90" class="logo" />
			</a>
        ...
        <!--khung chứa sản phẩm-->
			...
			<div class="khung-chua-san-pham">
                <!--Phần section 1-->
                <div class="section">
                    <h1>Vui Lòng đăng nhập để được khải nghiệm sản phẩm của chúng tôi</h1>
                </div>    
                <!--end section 1-->
