    ...
    <div class="Sum">
        ...
        <div class="khung-chua-san-pham">
            <div class="section">
              ...
              <input type="text" class="inp"   name="user" placeholder="Tên đăng nhập"/><br>
              ...
              <input type="password" class="inp" name="pass" placeholder="Mật khẩu"/><br>
              <?php if (isset($loi['pass'])) { ?>
              <span style="color: red"><?php echo $loi['pass']; ?></span>
              <?php } ?><br>

                <button class="btn-lg" name="btn_user" >Đăng nhập</button>
                <p>Hoặc</p>
                
                <span><a href="Dang_ky.html"  style="width:120px;">Tôi chưa có tài khoản</a></span>
